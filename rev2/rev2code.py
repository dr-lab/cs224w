...
full_birdnest_user = cPickle.load(open("data/%s_birdnest_user.pkl" % NETWORKNAME, "rb"))
full_birdnest_product = cPickle.load(open("data/%s_birdnest_product.pkl" % NETWORKNAME, "rb"))

full_birdnest_edge = []
try:
    print 'loading birdnest pickle'
    full_birdnest_edge = cPickle.load(open("./data/%s_edge_birdnest.pkl" % NETWORKNAME, "rb"))
    edge_map = cPickle.load(open("./data/%s_edge_map.pkl" % NETWORKNAME, "rb"))
